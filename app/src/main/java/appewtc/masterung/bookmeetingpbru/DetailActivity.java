...
public class DetailActivity extends AppCompatActivity {
    ...
    private TextView nameRoomTextView, nameBuildTextView, sizeTextView,
            priceDayTextView, priceHolidayTextView;
    private ImageView imageView;
    private String nameRoomString, namebuildString, sizeString, priceDayString, priceHolidayString,
    ...
    private void showTextView() {
        ...
        priceHolidayTextView.setText(priceHolidayString);
    ...
    private void receiveValue() {
        ...
        priceHolidayString = getIntent().getStringExtra("PriceHoliday");
    ...
    private void bindwidget() {
        ...
        priceHolidayTextView = (TextView) findViewById(R.id.textView17);
