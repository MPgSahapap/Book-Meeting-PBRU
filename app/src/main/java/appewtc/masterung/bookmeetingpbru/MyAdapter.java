...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        sizeTextView.setText( "จุคนได้ " + sizeStrings[i]+"คน");

        TextView priceDayTextView = (TextView) view1.findViewById(R.id.textView11);
        priceDayTextView.setText("วันธรรมดา " + priceDayStrings[i]+"บาท");

        TextView priceHoliTextView = (TextView) view1.findViewById(R.id.textView12);
        priceHoliTextView.setText("วันหยุด " + priceHolidayStrings[i]+"บาท");
